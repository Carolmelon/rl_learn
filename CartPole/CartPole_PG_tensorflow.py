...
class PolicyGradient:
    ...
    def __init__(self, n_features, n_actions, learning_rate=0.01, reward_decay=0.95):
        ...
        def get_model(inputs_shape):
            ...
            with tf.name_scope('inputs'):
                self.tf_obs = tl.layers.Input(
                    inputs_shape, tf.float32, name="observations")
    ...
    def load_ckpt(self):
        ...
        tl.files.load_hdf5_to_weights_in_order(
            'model/pg_policy.hdf5', self.model)
            ...
            while True:
                ...
                if done:
                    ...
                    print(
                        ...
                        (i_episode, num_episodes, ep_rs_sum,
